...
-- CreateEnum
CREATE TYPE "EmbeddingSourceType" AS ENUM ('GITHUB_REPO', 'GITHUB_README', 'GITHUB_CODE', 'GITHUB_LANGUAGES', 'LINKEDIN_PROFILE', 'LINKEDIN_EXPERIENCE', 'LINKEDIN_EDUCATION', 'LINKEDIN_SKILLS', 'RESUME', 'RESUME_REPO');
